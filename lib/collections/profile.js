...
Media = new SimpleSchema({
            title:     {  type: String,    optional: true,     label: "Title",             max: 200  },
            desc:      {  type: String,    optional: true,     label: "Desc",              max: 200  },
            url:       {  type: String,    optional: true,     label: "Rating",              max: 200  }    
        });
...
Experience = new SimpleSchema({
            ...
            media:           {  type: [Media],   optional: true,     label: "Media",         max: 20000 }, 
